...
class ADDR:
    ...
    DERIVE_KEY = 0x00A2EA79

    # 55 8B EC 53 56 57 E9 ?? ?? ?? ??
    INIT_WITH_KEY = 0x0055F3A3

    # 88 51 0E 66 85 DB 0F 85 ?? ?? ?? ?? E9 ?? ?? ?? ??
    GEN_KEYSTREAM = 0x0055E51F

    # B8 ?? ?? ?? ?? C3 6A ?? 58 C3
    PLAYPLAY_TOKEN = 0x01263048


class PLAYPLAY_VM:
    ADDR_G_WORKSPACE_POOL = 0x01C30ED0
    WORKSPACE_POOL_SIZE = 68096  # 0x10A00
    WORKSPACE_CONST_OFFSET = 1024
    WORKSPACE_CONST_SIZE = 1536  # 0x600

    CONST_TABLE_VA_START = 0x01263240
...
class STUB_ADDRS:
    ...
    THUNK_JMP_RET = 0x0106FA17

    MTX_UNLOCK = 0x0105AF41
    CND_SIGNAL = 0x0105C512
    CND_WAIT = 0x0105C5F9
    UNIQUE_LOCK_CTOR = 0x004ECE59
