...
class ADDR:
    ...
    DERIVE_KEY = 0x008676DB

    # 55 8B EC 53 56 57 E9 ?? ?? ?? ??
    INIT_WITH_KEY = 0x005713F2

    # 88 51 0E 66 85 DB 0F 85 ?? ?? ?? ?? E9 ?? ?? ?? ??
    GEN_KEYSTREAM = 0x0057058E

    # B8 ?? ?? ?? ?? C3 6A ?? 58 C3
    PLAYPLAY_TOKEN = 0x01250D90


class PLAYPLAY_VM:
    ADDR_G_WORKSPACE_POOL = 0x01C60AA0
    WORKSPACE_POOL_SIZE = 68096  # 0x10A00
    WORKSPACE_CONST_OFFSET = 1024
    WORKSPACE_CONST_SIZE = 1536  # 0x600

    CONST_TABLE_VA_START = 0x01250F90
...
class STUB_ADDRS:
    ...
    MTX_UNLOCK = 0x010903B9
    CND_SIGNAL = 0x01091982
    CND_WAIT = 0x01091A69
    UNIQUE_LOCK_CTOR = 0x004ECAC5
