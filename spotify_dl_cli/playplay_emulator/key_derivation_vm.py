...
ADDR_G_PLAYPLAY_VM_WORKSPACE_POOL = 0x01BC6DE8
VM_WORKSPACE_POOL_SIZE = 68096  # 0x10A00
VM_WORKSPACE_CONST_OFFSET = 1024
VM_WORKSPACE_CONST_SIZE = 1536

CONST_TABLE_VA_START = 0x011C2CF8
CONST_TABLE_VA_END = 0x011C2CF8 + VM_WORKSPACE_CONST_SIZE
